    ...
    <>
        ...
        <div className="flex items-center gap-6 ">
          <div className="flex space-x-4">
            ...
            <a href="https://www.tiktok.com" target="_blank" rel="noopener noreferrer">
              <img className="h-6 w-6" src={tiktok} alt="TikTok" />
            </a>
            <a
            ...
            >
              <img className="h-6 w-6" src={sap} alt="WhatsApp" />
            </a>

            <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
              <img className="h-6 w-6" src={ig} alt="Instagram" />
            </a>
          </div>
        </div>
      </div>
      ...
      <div>
        <nav className="flex items-center justify-between max-w-7xl m-auto">
          <div>
            <img className="w-32 h-32 object-contain" src={logotipolaliz} alt="" />
          </div>
          ...
          <div className="items-center gap-6 md:flex hidden">
            ...
            <div className="flex gap-1">
              <div>
                <a
                  href='http://muebleslaliz.com/login.html'
